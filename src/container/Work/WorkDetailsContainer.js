					...
					<div className='row'>
						<div className='col-lg-6 col-md-6 col-12'>
							<div className='thumbnail' data-aos='fade-up'>
								<img
									className='w-100'
									src={process.env.PUBLIC_URL + data.workdetail_gallary[0]}
									alt='Agency'
								/>
							</div>
						</div>
						<div className='col-lg-6 col-md-6 col-12 mt-lg-0 mt-md-0 mt-10'>
							<div className='thumbnail' data-aos='fade-up'>
								<img
									className='w-100'
									src={process.env.PUBLIC_URL + data.workdetail_gallary[1]}
									alt='Agency'
								/>
							</div>
						</div>
						...
						<div className='col-lg-12 my-6'>
							<div className='thumbnail' data-aos='fade-up'>
								<img
									className='w-100'
									src={process.env.PUBLIC_URL + data.workdetail_gallary[2]}
									alt='Agency'
								/>
							</div>
						</div>
