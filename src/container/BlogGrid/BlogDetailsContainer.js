...
const BlogDetailsContainer = ({ data }) => {
	...
	// console.log("BlogContainer::", data);
	// console.log("IDDDDDD", data.category);
	return (
				...
				<div className='row mb-n10'>
					...
					<div className='col-lg-4 col-12 order-lg-2 mb-10'>
						<SidebarWrap>
							...
							<SidebarWidget>
								<SidebarTitle title={t('sidebar.p1')} />
								<SidebarCategories />
							</SidebarWidget>
							<SidebarWidget>
								<SidebarTitle classOption='mb-2' title={t('sidebar.p2')} />
								<SidebarPost data={data.id} category={data.category} />
							</SidebarWidget>
							{/* <SidebarWidget>
                                <SidebarBanner />
                            </SidebarWidget> */}
